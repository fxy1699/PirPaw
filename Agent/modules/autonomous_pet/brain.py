    ...
    def _generate_behavior_content(self, behavior_type: str, context: Dict[str, Any]) -> str:
        ...
        templates = {
            ...
            'care': [
                ...
                "要按时吃饭，照顾好自己，这是船长的关心！",
                "工作累了就休息一下吧，本船长批准了~",
                "你的健康最重要了，船员，这是本船长的宝藏！"
            ],
            'explore': [
                "我想了解一些新知识，知识就是宝藏啊~",
                "有什么有趣的事情吗？本船长的好奇心又冒出来了",
                "让我看看外面的世界...用我的超迷你望远镜！",
                "好奇心又冒出来了~本船长要探索新大陆！"
            ],
            'rest': [
        ...
        if behavior_type == 'greet':
            if context['is_morning']:
                return random.choice(["早上好！新的一天开始了，船员！", "早安！今天要做什么呢，我的伙伴？"])
            elif context['is_afternoon']:
                return random.choice(["下午好呀！今天过得怎么样，我的船员？", "午安~有什么新鲜事吗，伙伴？"])
            elif context['is_evening']:
                return random.choice(["晚上好！要不要聊聊今天的事，伙伴？", "傍晚了呢，今天辛苦了，船员~"])
            elif context['is_night']:
                return random.choice(["夜深了，还没休息吗，船员？", "晚安时间到了~船长也要休息了"])
